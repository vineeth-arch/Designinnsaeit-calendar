...
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Design Innsaeit";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "help@cal.com";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Design Innsaeit";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Design Innsaeit";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Design Innsaeit";
...
// Served directly by /api/social/og/image; the Next image optimizer is bypassed.
...
// Typed as string (not the literal) so test mocks / org overrides can hold any hex.
export const DEFAULT_LIGHT_BRAND_COLOR: string = "#FF006C";
export const DEFAULT_DARK_BRAND_COLOR: string = "#00FFCF";
